...
Examples of representing this project include using an official project email
address, posting via an official project social media account, or acting as an
appointed representative at an online or offline event.

## Reporting

Instances of abusive, harassing, or otherwise unacceptable behavior may be
reported by opening an issue in this repository and using the label
`code-of-conduct` or by emailing the project maintainers. If you prefer
confidential reporting, please email the maintainers at `hubertus@hubertusbecker.com`.

All complaints will be reviewed and investigated promptly and fairly. All
project maintainers are obligated to respect the privacy and security of the
reporter of any incident.

If you are unsure whom to contact, open an issue and the maintainers will
connect you with the appropriate person to handle the report.
...
communication with the project community for a specified period of time. No
