...
const isDockerLocalRegistryRunning = async () => {
	...
	return lsOfRunningContainers.some(
		(row) =>
...
const runJob = async (startLog, cmdAsyncCallback) => {
	console.log("---------JOB---------");
